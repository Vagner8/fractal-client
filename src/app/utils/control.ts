...
import { ControlKeys, SplitIndicators } from '@constants';
...
export class ControlFactory {
  ...
  private addToParentSort(indicator: string, parent: Fractal): void {
    const parentSortForm = parent.getControlForm(SplitIndicators.Sort);
    const parentSortControl = parent.getControl(SplitIndicators.Sort);
